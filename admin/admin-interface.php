...
function propanel_siteoptions_add_admin() {
    ...
    $tt_page = add_theme_page('Site Options', 'تنظیمات قالب', 'edit_theme_options', 'siteoptions','propanel_siteoptions_options_page');
...
<div class="wrap" id="truethemes_container">
  <div id="of-popup-save" class="of-save-popup">
    <div class="of-save-save">تغییرات ذخیره شد</div>
  </div>
  ...
  <form action="<?php echo esc_attr( $_SERVER['REQUEST_URI'] ) ?>" method="post" style="display:inline" id="ofform-reset">
    ...
    <input name="reset" type="submit" value="بازگرداندن به تنظیمات اولیه" class="button submit-button reset-button" onclick="return confirm('CAUTION: Any and all settings will be lost! Click OK to reset.');" />
